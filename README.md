...
2. Use the Left and Right arrow keys to dodge the obstacles
3. Accumulate points and aim for the ultimate high score!

## 🛠️ Built With
* **HTML5 & JavaScript Canvas** - For the core game rendering pipeline and runtime loop logic.
* **Tailwind CSS (via Play CDN)** - For a polished, responsive, and glassmorphic user interface.
...
3. Use the **Live Server** extension to launch it instantly in your local browser environment.
